  ...
  return (
    <>
      ...
      <div className="verification">
        ...
        <div id="veri-sec">
          <p>
            Kindly enter the 4- digit code OTP sent to your phone number to
          ...
          <p>
            Receive a verification link on the email address provided during
            registration to verify your email address.
          </p>
